...
export const NavBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 shadow shadow-unsij-black-50">
      <div className="h-[8vh] bg-unsij-green-950 flex items-center justify-between lg:justify-center px-4">
        <Link
          to="/"
          className="flex flex-row gap-1 justify-center items-center"
        >
          <img className="block w-16" src={logo} alt="Logo" />
          <span className="mr-4 text-white text-xs md:text-2xl lg:text-xl 2xl:text-2xl font-medium hidden lg:inline">
